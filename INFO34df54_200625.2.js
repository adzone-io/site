...
(function(t) {
t.version = '200625.2';
t.version_datetime = '2020-Jun-25 17:40:17';
...
t.page_path = (function() { return "/" + getDfpPathRoot() + getMetaContent("dfpPageType") + "/" })();
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('zocalo'.toLowerCase())>=0) { params='{}'; timeout = 0; type_id='108'; params=JSON.parse('{}'); }
      var ignore = false;
      if(e.lineItemId && ',,{},'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      ...
      if(!ignore && div_id.toLowerCase().indexOf('interstitial'.toLowerCase())>=0) { params='{"backgroundColor":"rgb(255,255,255,0.95)", "autoclose":"8"}'; timeout = 0; type_id='103'; params=JSON.parse('{"backgroundColor":"rgb(255,255,255,0.95)", "autoclose":"8"}'); }
      if(type_id) {
...
return kv; })();
t.size_mapping=[{"device": "desktop", "adtype": "box", "min_width": 0, "sizes": [[300, 250], "fluid"], "refresh": 0}, {"device": "desktop", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 600], [300, 250]], "refresh": 0}, {"device": "desktop", "adtype": "push", "min_width": 0, "sizes": [[970, 90], [970, 250], [728, 90]], "refresh": 0}, {"device": "desktop", "adtype": "top", "min_width": 0, "sizes": [[970, 60], [970, 80]], "refresh": 0}, {"device": "desktop", "adtype": "megalateral", "min_width": 1280, "sizes": [[250, 600], [120, 600], [160, 600]], "refresh": 0}, {"device": "desktop", "adtype": "header", "min_width": 0, "sizes": [[180, 70]], "refresh": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 0, "sizes": [[940, 80], [728, 90], [1, 1]], "refresh": 0}, {"device": "desktop", "adtype": "inline", "min_width": 0, "sizes": [[1, 1], [640, 480], [640, 360], [468, 60], "fluid"], "refresh": 0}, {"device": "desktop", "adtype": "interstitial", "min_width": 800, "sizes": [[800, 600]], "refresh": 0}, {"device": "mobile", "adtype": "box", "min_width": 0, "sizes": [[300, 250], [320, 50], "fluid"], "refresh": 0}, {"device": "mobile", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [320, 50], "fluid"], "refresh": 0}, {"device": "mobile", "adtype": "top", "min_width": 0, "sizes": [[320, 50]], "refresh": 0}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[320, 50], [1, 1]], "refresh": 0}, {"device": "mobile", "adtype": "inline", "min_width": 0, "sizes": [[1, 1], "fluid"], "refresh": 0}, {"device": "mobile", "adtype": "interstitial", "min_width": 0, "sizes": [[300, 416], [320, 480]], "refresh": 0}, {"device": "mobile", "adtype": "interstitial", "min_width": 0, "sizes": [[518, 690]], "refresh": 0}];

(function() {  })();
(function() { 
// extra slots
  var ad_slots = []; // count: 1
(true) && ad_slots.push({ div:   , location: 'after' , id: '' , adtype: '', floating: false, css: '', class: '' });

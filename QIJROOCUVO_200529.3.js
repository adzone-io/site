...
if(pageinfo.type == "interior") {
  ad_slots = [
  { div: document.querySelectorAll('.textonota > p')[3] , location: "after" , id: "horizontal4" , adtype: "horizontal_nota" },
  { div: document.querySelectorAll('.textonota > p')[6] , location: "after" , id: "horizontal4" , adtype: "horizontal_nota" },
  { div: document.querySelectorAll('.textonota > p')[9] , location: "after" , id: "horizontal4" , adtype: "horizontal_nota" },
  { div: document.querySelectorAll('.textonota > p')[12] , location: "after" , id: "horizontal4" , adtype: "horizontal_nota" },
  ];
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('flotante2'.toLowerCase())>=0) { params='{}'; timeout = 500; type_id='108'; params=JSON.parse('{}'); }
      var ignore = false;
      if(e.lineItemId && ',,{},'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      ...
      if(!ignore && div_id.toLowerCase().indexOf('flotante1'.toLowerCase())>=0) { params='{"autoclose":"8", "backgroundColor":"white"}'; timeout = 10; type_id='103'; params=JSON.parse('{"autoclose":"8", "backgroundColor":"white"}'); }
      if(type_id) {
...
t.kv = (function() { return { seccion: pageinfo.section||"n/a" } })();
t.size_mapping=[{"device": "desktop", "adtype": "header", "min_width": 0, "sizes": [[240, 90]], "refresh": 120}, {"device": "desktop", "adtype": "horizontal", "min_width": 1000, "sizes": [[970, 90], [970, 250], [728, 90]], "refresh": 120}, {"device": "desktop", "adtype": "horizontal", "min_width": 800, "sizes": [[728, 90], [300, 250], [320, 250], [320, 100]], "refresh": 120}, {"device": "all_devices", "adtype": "horizontal", "min_width": 0, "sizes": [[300, 250], [320, 250], [320, 100]], "refresh": 120}, {"device": "desktop", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [300, 300]], "refresh": 120}, {"device": "mobile", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [320, 250], [300, 100], [320, 100]], "refresh": 120}, {"device": "all_devices", "adtype": "caja_grande", "min_width": 0, "sizes": [[300, 600], [300, 250], [300, 630]], "refresh": 120}, {"device": "desktop", "adtype": "flotante1", "min_width": 800, "sizes": [[1, 1], [800, 600], [1000, 600], [600, 500]], "refresh": 0}, {"device": "desktop", "adtype": "flotante2", "min_width": 728, "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "refresh": 0}, {"device": "mobile", "adtype": "flotante1", "min_width": 0, "sizes": [[320, 480]], "refresh": 0}, {"device": "mobile", "adtype": "flotante2", "min_width": 0, "sizes": [[300, 50], [320, 50]], "refresh": 120}, {"device": "desktop", "adtype": "flotante3", "min_width": 0, "sizes": [[1, 1]], "refresh": 0}, {"device": "desktop", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[728, 90], [300, 250], [320, 250]], "refresh": 120}, {"device": "mobile", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[300, 250], [320, 250], [320, 100]], "refresh": 120}];

...
t.version_datetime = '2020-Sep-09 23:26:00';
...
if(adzone.page=="nota") {
  ...
  ad_slots.push({ div: document.querySelectorAll("section")[7], location: 'after' , id: 'wide_5' , adtype: 'billboard', style:'margin-top:-40px; margin-bottom:-40px' });

...
t.version_datetime = '2020-Aug-18 15:25:06';
...
if(adzone.device.isMobile && adzone.page=='home') {
  ...
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[0], location: 'after' , id: 'rectangle2' , adtype: 'rectangle' });

  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[2], location: 'after' , id: 'rectangle4' , adtype: 'rectangle-big' });

  ad_slots.push({ div: document.querySelectorAll(".zox-post-body")[0], location: 'after' , id: 'rectangle6' , adtype: 'rectangle-small' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body")[0], location: 'after' , id: 'rectangle5' , adtype: 'rectangle' });

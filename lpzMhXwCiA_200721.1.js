...
(function(t) {
t.code = 'lpzMhXwCiA.200721.1';
t.version = '200721.1#1151';
t.version_datetime = '2020-Jul-21 12:36:32';
...
adzone.slotRenderedCallback["Nueva_Red_Interior/www.datachaco.com/Home_Residual"] = function(event) {
    if (!event.isEmpty) {
        document.body.className += " style-home-event";
        if(document.getElementsByClassName('banner-side-left')[0]!=undefined){
            document.getElementsByClassName('banner-side-left')[0].style.display = 'none';
        }
        if(document.getElementsByClassName('banner-side-right')[1]!=undefined){
            document.getElementsByClassName('banner-side-right')[1].style.display = 'none';
        }
        
        if(document.getElementsByClassName('main-header')[0]!=undefined){
            var socialBar = document.getElementsByClassName('social-sidebar')[0];
            if (socialBar===undefined){
                document.getElementsByClassName('main-header')[0].className += " style-home-event";
            } else {
                socialBar.style.marginLeft = "-60px";
            }
        }
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "desktop", "adtype": "floating", "min_width": 1366, "sizes": [[260, 650], [260, 600], [300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "itt", "min_width": 0, "sizes": [[1000, 480], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 0, "sizes": [[728, 90], [950, 90], [950, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 0, "sizes": [[1000, 480], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 320, "sizes": [[320, 480]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 480, "sizes": [[480, 320]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[300, 50], [320, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}];

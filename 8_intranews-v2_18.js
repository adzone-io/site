...
t.version_datetime = '2020-Aug-20 13:02:53';
...
t.styles = t.styles || {}
t.styles.footer_close=`<img style='max-width:20px;max-height:20px;width:20px;height:20px;margin-top:0px;margin-right:-2px' src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/icon/close_square.png">`;
...
t.get_page_path = function() { var prefix = "";
if (document.location.pathname=="/") {
  prefix = "H" + (adzone.device.isDesktop?"D":"M");
  adzone.page = "home";
  adzone.category = "home";
} else if (document.location.pathname.split("/").length>3) {
  prefix = "N" + (adzone.device.isDesktop?"D":"M");
  adzone.page = "nota";
  if(document.querySelector("h3.zox-post-cat a span")) {
    adzone.category = document.querySelector("h3.zox-post-cat a span").innerHTML.toLowerCase();
  } else {
    adzone.category = "n/a";
  }  
} else {
  prefix = "C" + (adzone.device.isDesktop?"D":"M");
  adzone.page = "category";
  adzone.category = (document.location.pathname.split("/").length>0?document.location.pathname.split("/")[1]:"n/a");
}

return "/IntraNews2020/" + prefix   };
t.page_path = t.get_page_path();
var ad_slots = [];

if(adzone.device.isMobile && adzone.page=='home') {
  ad_slots.push({ div: document.querySelectorAll("section")[0], location: 'after' , id: 'rectangle1' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[0], location: 'after' , id: 'rectangle2' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[2], location: 'after' , id: 'rectangle3' , adtype: 'rectangle-big' });
  ad_slots.push({ div: document.querySelectorAll("article")[4], location: 'after' , id: 'rectangle4' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[6], location: 'after' , id: 'rectangle5' , adtype: 'rectangle-big' });

} else if(adzone.device.isMobile && adzone.page=='category') {
  ad_slots.push({ div: document.querySelectorAll("article")[0], location: 'before' , id: 'rectangle1' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[2], location: 'before' , id: 'rectangle2' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[4], location: 'before' , id: 'rectangle3' , adtype: 'rectangle-big' });
  ad_slots.push({ div: document.querySelectorAll("article")[6], location: 'before' , id: 'rectangle4' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll("article")[8], location: 'before' , id: 'rectangle5' , adtype: 'rectangle-big' });

} else if(adzone.device.isMobile && adzone.page=='nota') {
  ad_slots.push({ div: document.querySelectorAll("h1.zox-post-title")[0], location: 'after' , id: 'rectangle1' , adtype: 'rectangle' }); // agregar 20px margen arriba
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[0], location: 'after' , id: 'rectangle3' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[0], location: 'after' , id: 'rectangle2' , adtype: 'rectangle', css:"margin-bottom:20px" });

  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[2], location: 'after' , id: 'rectangle4' , adtype: 'rectangle-big' });
  //ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[3], location: 'before' , id: 'rectangle4' , adtype: 'rectangle-big' });

  ad_slots.push({ div: document.querySelectorAll(".zox-post-body")[0], location: 'after' , id: 'rectangle6' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body")[0], location: 'after' , id: 'rectangle5' , adtype: 'rectangle', css:"margin-bottom:20px" });
  

}

if(adzone.category && adzone.category in {"usa":1, "miami":1, "new york":1, "new-york":1, "mundo":1}) {
  // USA, MIAMI, New York, Mundo no deben tener el espacio top -> confirmar si es solo mobile, o desktop tambien
  document.querySelector(".ad-slot#top") && document.querySelector(".ad-slot#top").classList.remove("ad-slot");
}

document.querySelector("h1") && (document.querySelector("h1").style.marginBottom="20px");

ad_slots.length>0 && t.create_slots(ad_slots);


t.forced_slots = [];
t.forced_slots.push({s: `sticky`, f: `108`, t: `10`, p: `{}`, i:`` });
...
t.kv = (function() { return {"category": adzone.category} })();
t.size_mapping=[{"device": "desktop", "sizes": [[800, 600], [1, 1]], "adtype": "itt-suspendido", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [970, 90], [970, 251], [1, 1]], "adtype": "sticky", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [970, 90]], "adtype": "headertop", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [320, 50], [320, 100]], "adtype": "mobile-top", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [300, 250], [320, 50], [320, 100]], "adtype": "rectangle", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [300, 250], [300, 600], [320, 50], [320, 100]], "adtype": "rectangle-big", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 480], [300, 250], [1, 1]], "adtype": "itt-suspendido", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [320, 50], [320, 100], [1, 1]], "adtype": "sticky", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [320, 50], [320, 100]], "adtype": "rectangle-small", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}];
...
// extra slots
  ...
  ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'sticky' , adtype: 'sticky', floating: true, css: '', class: '' });
  ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'itt' , adtype: 'itt', floating: true, css: '', class: '' });
  (!(adzone.category in {"usa":1, "miami":1, "new york":1, "new-york":1, "mundo":1})) &&   ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'top' , adtype: 'mobile-top', floating: false, css: '', class: '' });
  (adzone.device.isDesktop && !(adzone.category in {"usa":1, "miami":1, "new york":1, "new-york":1, "mundo":1})) &&   ad_slots.push({ div_txt: `document.querySelector("header")`, div: function() { return (document.querySelector("header") || null);} , location: 'after' , id: 'headertop' , adtype: 'headertop', floating: false, css: 'overflow:', class: '' });
  ad_slots.length>0 && t.create_slots(ad_slots);

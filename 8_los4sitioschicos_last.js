...
t.version_datetime = '2020-Aug-17 00:07:46';
...
if(adzone.page_path.indexOf("nota")>0) {
  ...
  { div: document.querySelectorAll('.entry-content > p')[3] , location: "after" , id: "wide_2" , adtype: "nota_wide" },
  { div: document.querySelectorAll('.entry-content > p')[6] , location: "after" , id: "wide_3" , adtype: "nota_wide" },
  ];
...
// imprimir ITT sólo cada 30 minutos, sólo en notas
if(adzone.page_path.indexOf("nota")>0) {
var last_itt=localStorage.getItem("last_itt") || 0;
if(last_itt < ( Math.round((new Date()).getTime()/1000/1000)-30 )) {
  localStorage.setItem("last_itt", Math.round((new Date()).getTime()/1000/1000));
  ad_slots.push({ div: document.body , location: "first" , id: "itt" , adtype: "itt", floating: true, style: "display:none" });
}
// ejecutar siempre el ITT
//ad_slots.push({ div: document.body , location: "first" , id: "itt" , adtype: "itt", floating: true, style: "display:none" });
}
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "desktop", "sizes": [[970, 90], [728, 90]], "adtype": "top", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 50], [300, 50], [300, 250], [320, 250], [320, 100], [300, 100]], "adtype": "top", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], "728", "250", [970, 90], [970, 250]], "adtype": "wide", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 50], [300, 100], [300, 50], [320, 100], [300, 250]], "adtype": "wide", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "box", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250], [300, 600]], "adtype": "bigbox", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[800, 600], [1000, 540]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 480]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "adtype": "zocalo", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 50]], "adtype": "zocalo", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "wide", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "leftbox", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250], [300, 600]], "adtype": "leftbigbox", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], "728", "250"], "adtype": "nota_wide", "min_width": 0, "refresh": 120, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [""], "adtype": "", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}];

...
if(adzone.use_epl && document.location.href.indexOf("epl_hide=1")<0){
  adzone.use_epl = true;
  adzone.epl_hb_slots = 'flotante,fullcontent, zocalo,itt,topbanner,homeevent,Home_320x50_Mob,A24_1X1';
...
t.version_datetime = '2020-Nov-18 22:01:18';
...
adzone_special.interval = 5; // minutes
...
if(adzone_special && adzone_special.run) {
  ...
  document.head.appendChild(s);
    ...
    console.log("document.getElementById('cover-all') : " + document.getElementById('cover-all'));
    document.getElementById('cover-all').remove();
}*/

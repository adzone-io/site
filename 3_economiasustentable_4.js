...
t.version_datetime = '2020-Sep-01 15:01:46';
...
t.get_page_path = function() { var l = document.location.pathname.split("/").length;
var path = "home";
if(l==2) {
  path = "seccion";     
} else {
...
return "/economiasustentable/" + path + "_";
 };
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "desktop", "sizes": [[970, 90], [970, 200], [970, 250]], "adtype": "horizontal", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "caja", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [300, 100], [320, 50], [320, 100]], "adtype": "horizontal", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250]], "adtype": "caja", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}];

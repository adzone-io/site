...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{"backgroundColor":"white", "autoclose":"8"}'; timeout = 10; type_id='103'; params=JSON.parse('{"backgroundColor":"white", "autoclose":"8"}'); }

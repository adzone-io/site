...
t.version_datetime = '2020-Nov-19 22:12:16';
...
t.get_page_path = function() { var site = "algarabia";
...
adzone.slotRenderedCallbackAll = function(e) {
  ...
  if(!e.size || !e.size[1] || div_id.indexOf("oop")<0) { return; }
  var w = e.size[0];
  var h = e.size[1];
  var format = 0;
  var params = {};
  if(adzone.device.isMobile) {
    if(w>300 && w<360 && h>470) { // itt
      params = {"autoclose": "8", "backgroundColor": "#ffffff", "width": w, "height": h};
      format = 103;
    } else if(w<300 && w<360 && h>470) { // footer
      format = 108;
    }

  } else { // desktop
    if(w>770 && w<810 && h>550) { // itt
      params = {"autoclose": "8", "backgroundColor": "#ffffff", "width": w, "height": h};
      format = 103;
    } else if(w>720 && h<100) { // footer
      format = 108;
    }    
  }
  if(format>0) {
    timeout = 1;
    var m = { data: {m:"adzone", a:"print", f:format, div_id: div_id, p: params }};
...
if(document.location.href.indexOf("algarabianinos")>0) {
  section = "algarabianinos"
}

return { "algarabia_seccion": section } })();
t.size_mapping=[{"device": "desktop", "sizes": [[728, 90], [970, 250], [970, 90]], "adtype": "top", "minwidth": 728, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250], [300, 600], [160, 600]], "adtype": "sidebar", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90]], "adtype": "top2", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [800, 600], [728, 90], [970, 90]], "adtype": "oop", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [970, 250], [970, 90]], "adtype": "internote", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [320, 50], [300, 100], [320, 100]], "adtype": "internote", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1, 1], [320, 480], [320, 50], [300, 50]], "adtype": "oop", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 100], [300, 250], [320, 100]], "adtype": "sidebar", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 100], [300, 250]], "adtype": "top2", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 100]], "adtype": "top", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}];

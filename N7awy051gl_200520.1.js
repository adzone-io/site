...
var isMobile = adzone.device.isMobile;
var isDesktop = !isMobile;
var isHome = (adzone.section == "home");
var isSeccion = (adzone.section == "seccion");
var isNota = (adzone.section == "nota");


var ad_slots = [];

ad_slots.push({ div: document.body , location: "first" , id: "itt" , adtype: "itt", floating: true });
ad_slots.push({ div: document.body , location: "first" , id: "zocalo" , adtype: "zocalo", floating: true });

if(adzone.section=="home") {
  if(adzone.device.isMobile) {
    ad_slots.push({ div: document.querySelector("#ad-container-HMRectangle1") , location: "first" , id: "top" , adtype: "top", style: "margin:20px 0" });
    ad_slots.push({ div: document.querySelectorAll("main>.container")[0] , location: "before" , id: "box_1" , adtype: "bigbox", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-2") , location: "before" , id: "box_2" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-4") , location: "before" , id: "box_3" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-7") , location: "before" , id: "box_4" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-6") , location: "before" , id: "box_5" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector(".site-footer") , location: "before" , id: "box_6" , adtype: "box", style: "" });

  } else {
    ad_slots.push({ div: document.querySelector("#ad-container-HDHeaderTop") , location: "first" , id: "top" , adtype: "top", style: "" });
    ad_slots.push({ div: document.querySelectorAll("main>.container")[0] , location: "before" , id: "wide_1" , adtype: "wide", style: "" });
    ad_slots.push({ div: document.querySelectorAll("main>.container")[2] , location: "before" , id: "wide_2" , adtype: "wide", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-4") , location: "before" , id: "box_1" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector("main>.modulo-4") , location: "before" , id: "box_2" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelector(".site-footer") , location: "before" , id: "wide_6" , adtype: "wide", style: "" });
  }

}

if(isDesktop && (isSeccion || isNota)) {
...
if(isSeccion) {
  ad_slots.push({ div: document.querySelector("#ad-container-CDHeaderTop") , location: "first" , id: "top" , adtype: "top", style: "margin:20px 0" });
  ad_slots.push({ div: document.querySelectorAll("main>.container")[0] , location: "before" , id: "box_1" , adtype: "bigbox", style: "" });
  for(var i = 0; i<document.querySelectorAll("article").length; i++){
    if(i%4==0) {
      ad_slots.push({ div: document.querySelectorAll("article")[i] , location: "after" , id: "wide_1" , adtype: "wide", style: "" });
    }
  }
  ...
  ad_slots.push({ div: document.querySelector("#ad-container-NDHeaderTop") , location: "first" , id: "top" , adtype: "nota_wide", style: "margin:20px 0" });
  for(var i = 1; i<document.querySelectorAll(".entry-content > .content-field > p").length; i++){
    if(i%4==0) {
      ad_slots.push({ div:document.querySelectorAll(".entry-content > .content-field > p")[i] , location: "after" , id: "wide_1" , adtype: "nota_wide", style: "" });
    }
  }

}

document.querySelector(".sticky-column") && (document.querySelector(".sticky-column").innerHTML="");
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('zocalo'.toLowerCase())>=0) { params='{}'; timeout = 500; type_id='108'; params=JSON.parse('{}'); }
      if(div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{}'; timeout = 0; type_id='103'; params=JSON.parse('{}'); }
      if(type_id) {
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "desktop", "adtype": "top", "min_width": 700, "sizes": [[970, 90], [728, 90]], "refresh": 120}, {"device": "mobile", "adtype": "top", "min_width": 0, "sizes": [[320, 50], [300, 50], [320, 100], [300, 100]], "refresh": 120}, {"device": "desktop", "adtype": "wide", "min_width": 700, "sizes": [[728, 90], "728", "250", [970, 90], [970, 250]], "refresh": 120}, {"device": "mobile", "adtype": "wide", "min_width": 0, "sizes": [[320, 50], [300, 100], [300, 50], [320, 100], [300, 250]], "refresh": 120}, {"device": "all_devices", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 120}, {"device": "all_devices", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [300, 600]], "refresh": 120}, {"device": "desktop", "adtype": "itt", "min_width": 800, "sizes": [[800, 600], [1000, 540]], "refresh": 0}, {"device": "mobile", "adtype": "itt", "min_width": 0, "sizes": [[320, 480]], "refresh": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 700, "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "refresh": 120}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[320, 50], [300, 50]], "refresh": 120}, {"device": "desktop", "adtype": "wide", "min_width": 0, "sizes": [[300, 250]], "refresh": 120}, {"device": "desktop", "adtype": "leftbox", "min_width": 992, "sizes": [[300, 250]], "refresh": 120}, {"device": "desktop", "adtype": "leftbigbox", "min_width": 992, "sizes": [[300, 250], [300, 600]], "refresh": 120}, {"device": "desktop", "adtype": "nota_wide", "min_width": 700, "sizes": [[728, 90], "728", "250"], "refresh": 120}];

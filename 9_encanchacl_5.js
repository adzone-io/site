...
t.code = '9_encanchacl';
t.version = '5';
t.version_datetime = '2020-Nov-20 21:53:35';
...
t.styles.prestitial_close=`<img style="left:-770px;height: 24px;margin-top:-40px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_logo_1.png"> <img style="right:0;height: 28px;margin-top: -42px;position:absolute;left:-940px" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_close_1.png">`;
...
t.styles.itt_z_index=`5000000000`;

console.log(111);
if((/Mobi/.test(navigator.userAgent))) {
console.log(222);
  adzone.styles.prestitial_close=`
    <img style="left:-294px;height: 18px;margin-top: -30px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_logo_1.png">
    <img style="left:-401px;right:0;height: 19px;margin-top: -29px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_close_1.png">`;
} else {

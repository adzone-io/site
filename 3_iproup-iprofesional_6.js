...
t.version_datetime = '2020-Aug-20 16:49:09';
...
window.addEventListener('load', (event) => {
	if(pageinfo && pageinfo.type && pageinfo.type == 'interior')
	{
		...
		{
  			let selector = '.textonota p:nth-child(0n+' + index + ')' 
  			console.log(selectpr, document.querySelector(selector) && document.querySelector(selector).nextElementSibling && 'P' === document.querySelector(selector).nextElementSibling.tagName && 'P' === document.querySelector(selector).tagName && '' !== document.querySelector(selector).value)
  			return document.querySelector(selector) && document.querySelector(selector).nextElementSibling && 'P' === document.querySelector(selector).nextElementSibling.tagName && 'P' === document.querySelector(selector).tagName && '' !== document.querySelector(selector).value
		}

		let index = 2
		while (ad_slots.length < 2)
		{
  			if (true === paragraphValidate(index))
  			{
				ad_slots.push({ div: document.querySelector('.textonota p:nth-child(0n+' + index + ')'), location: "after" , id: "horizontal4" , adtype: "horizontal_nota" })
				index = index + 2
  			}
  			else 
  			{
  			...
  			if (!document.querySelector('.textonota p:nth-child(0n+' + index + ')')) break
		}
...
var adsCount = 4;
if(document.querySelectorAll('.textonota p').length>18) { 
  adsCount = 6; 
} else if(document.querySelectorAll('.textonota p').length>15) { 
  adsCount = 5; 
}
var parMin = 3;
...
if(pageinfo && pageinfo.type && pageinfo.type == "interior")
{
    ...
    var parCount = Math.ceil(document.querySelectorAll('.textonota p').length / (adsCount + 1))
...
return kv; })();
t.size_mapping=[{"device": "desktop", "sizes": [[300, 250], [300, 300]], "adtype": "caja", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 600], [300, 250], [300, 630]], "adtype": "caja_grande", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [800, 600], [1000, 600], [600, 500]], "adtype": "flotante1", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "adtype": "flotante2", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1]], "adtype": "flotante3", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[240, 90]], "adtype": "header", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[970, 90], [970, 250], [728, 90], [970, 200], [950, 90], [950, 300], [950, 350]], "adtype": "horizontal", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [300, 250], [320, 250], [320, 100]], "adtype": "horizontal", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [300, 250], [320, 250]], "adtype": "horizontal_nota", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[640, 480]], "adtype": "inread", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[250, 600]], "adtype": "lateral", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [300, 100]], "adtype": "caja", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 600], [300, 250], [300, 630]], "adtype": "caja_grande", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1, 1], [320, 480]], "adtype": "flotante1", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1, 1], [480, 320]], "adtype": "flotante1", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [320, 50], [300, 100], [320, 100]], "adtype": "flotante2", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [300, 100], [320, 100], [320, 250]], "adtype": "horizontal", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [300, 100]], "adtype": "horizontal_nota", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}];

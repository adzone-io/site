...
t.version_datetime = '2020-Aug-25 16:59:58';
...
t.get_page_path = function() { var prefix = "seccion"; 
adzone.page = "seccion";
document.location.pathname.split("/")>0 && (adzone.category = document.location.pathname.split("/")[1])
...
return "/todojujuy/" + prefix + "_"; };
t.page_path = t.get_page_path();
adzone.repair = function(){
  var d = document.querySelectorAll(".ad-slot");
  for(var i = 0; i<d.length; i++) {
    if(d[i].id.indexOf("horizontal")>=0) {
      d[i].dataset.adtype="horizontal";  
    } else if(d[i].id.indexOf("caja")>=0) {
      d[i].dataset.adtype="caja";  
    } 
}
}

adzone.int = window.setInterval(adzone.repair,100);
window.setTimeout(function(){window.clearInterval(adzone.int)},5000);
...
adzone.slotRenderedCallbackAll = function(e) {
  ...
  if(e.isEmpty) { return; }
  if(e.slot.getSlotElementId().indexOf("lateral")<0) { return; }

  var d = document.getElementById(e.slot.getSlotElementId()).parentElement;
  d.style.cssText=";width:300px;height:600px;position:fixed;top: 100px;right:0;display:block;";
  adzone.lateral = d;
    
  adzone_move();
  window.addEventListener("resize", adzone_move);    
}

function adzone_move() {
  document.querySelector("#page-inner-wrap").style.marginLeft="-150px";
  var rect = document.querySelector(".region2 .clearfix").getBoundingClientRect();
  adzone.lateral.style.left = (rect.right + 20) + "px";
}
...
t.kv = (function() { return {"seccion": adzone.category }; })();
t.size_mapping=[{"device": "desktop", "sizes": [[300, 250]], "adtype": "caja", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[950, 90], [950, 250]], "adtype": "horizontal", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[800, 600]], "adtype": "itt", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[160, 600], [250, 600], [300, 600], [250, 800]], "adtype": "lateral", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[970, 90], [970, 251]], "adtype": "zocalo", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [320, 50], [300, 50]], "adtype": "caja", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [320, 90]], "adtype": "horizontal", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 480]], "adtype": "itt", "minwidth": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[480, 320]], "adtype": "itt", "minwidth": 500, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 50]], "adtype": "zocalo", "minwidth": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}];
...
// extra slots
  ...
  (adzone.device.isDesktop) &&   ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'lateral' , adtype: 'lateral', floating: true, css: '', class: '' });
  ...
  ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'zocalo' , adtype: 'zocalo', floating: true, css: '', class: '' });

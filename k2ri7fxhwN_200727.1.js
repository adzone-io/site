...
(function(t) {
t.code = 'k2ri7fxhwN.200727.1';
t.version = '200727.1#1217';
t.version_datetime = '2020-Jul-27 12:02:06';
...
adzone.slotRenderedCallback["www.lared.am/Notas/HomeEvent_260x650"] = function(event) {
    if (!event.isEmpty) {
        document.body.className += " style-home-event";
    }
};

adzone.slotRenderedCallback["www.lared.am/Home/HomeEvent_260x650"] = function(event) {
    if (!event.isEmpty) {
        $("#Home/Home_300x600_right").hide();   
        $("#adsTall").hide();
        $(".home").css("with", "calc(100% - 300px");
        window.localStorage.setItem("adsTall", true);
    }
};

adzone.slotRenderedCallback["www.lared.am/Home/TopBanner_950x50"] = function(event) {
    if (!event.isEmpty) {
        if (ads.device.isDesktop) {
            //console.log("INIT HOME EVENT CALLBACK");
            //$(".main-header").css("height", "140px");
            $(".main-header").attr(
                "style",
                "height: 140px; padding: 0!important!"
            );
            $(".player-wrapper").attr("style", "margin-top: 100px");
            $(".logo").attr("style", "top: 105px!important;");
        } else {
            $(".main-header").attr("style", "height:200px");
            var playerMargin = $(".navbar").height();            
            $(".main-player").attr("style", "margin-top:"+playerMargin+"px");
            $(".program-detail").attr("style", "margin-top:"+playerMargin+"px");
            $(".logo").attr("style", "margin-top:60px");
            $(".menu-icon").attr("style", "margin-top:60px");
            $(".player-widget").attr("style", "margin-top:120px");
        }
    }
};

adzone.slotRenderedCallback["www.lared.am/Home/TopBanner_OnlyDesk"] = function(event) {
    if (!event.isEmpty) {
        if (ads.device.isDesktop) {
            //console.log("INIT HOME EVENT CALLBACK");
            //$(".main-header").css("height", "140px");
            ...
            $("#main-player").attr("style", "margin-top: 140px");
            $(".player-wrapper").attr("style", "margin-top: 100px");
            $(".logo").attr("style", "top: 105px!important;");
        } else {
            $(".main-header").attr("style", "height:200px");
...
adzone.slotRenderedCallback["www.lared.am/Notas/TopBanner_950x50"] = function(event) {
    if ("event.isEmpty) {
        if (ads.device.isDesktop) {
            //$(".main-header").css("height", "140px");
            $(".main-header").attr(
            ...
            //$(".player-wrapper").attr('style',"margin-top: 200px");
            $(".logo").attr("style", "top: 105px!important;");
            $("#auxDownMenu").attr("style", "margin-top: 80px!important;");
        } else {
            $(".main-header").attr("style", "height:200px");
            $(".logo").attr("style", "margin-top:60px");
            $(".menu-icon").attr("style", "margin-top:60px");
...
adzonne.slotRenderedCallback["Home/OOP_Zocalo_dsk"] = function(event) {
    if (!event.isEmpty) {            
        $("#Home\\/OOP_Zocalo_dsk").css({"bottom":"60px"});
    } 
}
t.forced_slots = [];
t.forced_slots.push({s: `itt`, f: `103`, t: `0`, p: `{"backgroundColor": "white", "autoclose":8}`, i:`{}` });
t.forced_slots.push({s: `zocalo`, f: `108`, t: `500`, p: `{"hide_on_page_footer":"footer"}`, i:`{}` }); 
...
t.size_mapping=[{"device": "desktop", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 600], [300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "box600", "min_width": 0, "sizes": [[300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "firstpush", "min_width": 0, "sizes": [[728, 90], [950, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "floating", "min_width": 0, "sizes": [[260, 650], [260, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "flotante", "min_width": 0, "sizes": [[1000, 541], [1000, 481]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "fluid", "min_width": 0, "sizes": ["fluid", [300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "fullcontent", "min_width": 0, "sizes": [[1, 1], [1000, 480], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "itt", "min_width": 0, "sizes": [[1000, 480], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "push", "min_width": 0, "sizes": [[728, 90], [950, 50], [950, 200], [950, 250], [970, 90], [970, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "topbanner", "min_width": 0, "sizes": [[950, 50], [970, 90]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 0, "sizes": [[728, 90], [950, 90], [950, 50], [1, 1]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [300, 100], [300, 50], [300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "box600", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "firstpush", "min_width": 0, "sizes": [[320, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "flotante", "min_width": 320, "sizes": [[320, 481]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "fluid", "min_width": 0, "sizes": ["fluid", [300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "fullcontent", "min_width": 0, "sizes": [[1, 1], [320, 480]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "fullcontent", "min_width": 480, "sizes": [[1, 1], [480, 320]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 0, "sizes": [[1000, 480], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 320, "sizes": [[320, 480]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 480, "sizes": [[480, 320]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "push", "min_width": 0, "sizes": [[300, 250], [300, 100], [320, 50], [320, 100]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "topbanner", "min_width": 0, "sizes": [[300, 50], [320, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "underHeader", "min_width": 0, "sizes": [[300, 100], [320, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[300, 50], [320, 50], [1, 1]], "refresh": 0, "adx_refresh": 0, "interval": 0}];

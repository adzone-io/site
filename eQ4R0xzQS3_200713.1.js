...
(function(t) {
t.code = 'eQ4R0xzQS3.200713.1';
t.version = '200713.1#1100';
t.version_datetime = '2020-Jul-13 10:39:30';
...
try { 
(false && adzone.section=="nota") && ad_slots.push({ div_txt: `document.querySelector("header.container")`, div: function() { return (document.querySelector("header.container") || null);} , location: 'before' , id: 'header_top' , adtype: 'header_top', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot header_top')}
try { 
(false && adzone.section=="nota") && ad_slots.push({ div_txt: `document.querySelector("article.entry-article")`, div: function() { return (document.querySelector("article.entry-article") || null);} , location: 'first' , id: 'top' , adtype: 'top', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot top')}
try { 

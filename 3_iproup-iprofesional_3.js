...
t.version_datetime = '2020-Aug-20 12:44:39';
...
window.addEventListener('load', (event) => {
	if(pageinfo && pageinfo.type && pageinfo.type == 'interior')
	{
		...
		let paragraphValidate = index =>
		{
  			...
  			return document.querySelector(selector) && document.querySelector(selector).nextElementSibling && 'P' === document.querySelector(selector).nextElementSibling.tagName
		}

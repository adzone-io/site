...
if(isDesktop) {
  ...
  if(isHome) {
    ...
    // agrego cajas
    //ad_slots.push({ div: document.querySelectorAll(".col-4")[1] , location: "after" , id: "box_1" , adtype: "box", style: "", class:"col-4" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[7] , location: "after" , id: "box_1" , adtype: "box", style: "", class:"col-4" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[8] , location: "before" , id: "box_2" , adtype: "box", style: "", class:"col-4" });
    ad_slots.push({ div: document.querySelector(".banner-right") , location: "first" , id: "box_3" , adtype: "box", style: "", class:"" });

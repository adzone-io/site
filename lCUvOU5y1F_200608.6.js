...
adzone.slotRenderedCallback["A24/agro/Home_Residual"] = function (event) {
  console.log('CB ResidualAgro');
  if (!event.isEmpty){
    activeResidual();
    showResidual();
  }else{
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('layers'.toLowerCase())>=0) { params='{"backgroundColor": "white", "autoclose":8}'; timeout = 10; type_id='103'; params=JSON.parse('{"backgroundColor": "white", "autoclose":8}'); }
      var ignore = false;
      if(e.lineItemId && ',,{},'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      ...
      if(!ignore && div_id.toLowerCase().indexOf('zocalo'.toLowerCase())>=0) { params='{"hide_on_page_footer":"footer"}'; timeout = 1000; type_id='108'; params=JSON.parse('{"hide_on_page_footer":"footer"}'); }
      var ignore = false;
      if(e.lineItemId && ',,{},'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      ...
      if(!ignore && div_id.toLowerCase().indexOf('fullcontent'.toLowerCase())>=0) { params='{}'; timeout = 10; type_id='120'; params=JSON.parse('{}'); }
      if(type_id) {
...
t.size_mapping=[{"device": "all_devices", "adtype": "fluid", "min_width": 0, "sizes": ["fluid", [300, 250]], "refresh": 0}, {"device": "mobile", "adtype": "box600", "min_width": 0, "sizes": [[300, 250]], "refresh": 0}, {"device": "desktop", "adtype": "box600", "min_width": 0, "sizes": [[300, 600]], "refresh": 0}, {"device": "mobile", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [300, 100], [300, 50], [300, 600]], "refresh": 0}, {"device": "desktop", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 600], [300, 250]], "refresh": 0}, {"device": "desktop", "adtype": "push", "min_width": 0, "sizes": [[728, 90], [950, 50], [950, 200], [950, 250], [970, 90], [970, 250]], "refresh": 0}, {"device": "mobile", "adtype": "push", "min_width": 0, "sizes": [[300, 250], [300, 100], [320, 50], [320, 100]], "refresh": 0}, {"device": "desktop", "adtype": "firstpush", "min_width": 0, "sizes": [[728, 90], [950, 50], [950, 200], [950, 250], [970, 90], [970, 250]], "refresh": 0}, {"device": "mobile", "adtype": "firstpush", "min_width": 0, "sizes": [[300, 100], [320, 50]], "refresh": 0}, {"device": "mobile", "adtype": "underHeader", "min_width": 0, "sizes": [[300, 100], [320, 50]], "refresh": 0}, {"device": "desktop", "adtype": "fullcontent", "min_width": 0, "sizes": [[1, 1], [1000, 480], [1000, 540]], "refresh": 0}, {"device": "mobile", "adtype": "fullcontent", "min_width": 0, "sizes": [[1, 1], [320, 480]], "refresh": 0}, {"device": "mobile", "adtype": "fullcontent", "min_width": 480, "sizes": [[1, 1], [480, 320]], "refresh": 0}, {"device": "desktop", "adtype": "topbanner", "min_width": 0, "sizes": [[950, 50]], "refresh": 0}, {"device": "mobile", "adtype": "topbanner", "min_width": 0, "sizes": [[300, 50], [320, 50]], "refresh": 0}, {"device": "desktop", "adtype": "floating", "min_width": 0, "sizes": [[260, 650], [260, 600], [300, 600]], "refresh": 0}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[300, 51], [300, 50], [320, 51], [320, 50], [1, 1]], "refresh": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 0, "sizes": [[728, 91], [728, 90], [950, 90], [950, 50], [1, 1]], "refresh": 0}, {"device": "all_devices", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 0}, {"device": "all_devices", "adtype": "itt", "min_width": 0, "sizes": [[1000, 480], [1000, 540]], "refresh": 0}, {"device": "mobile", "adtype": "itt", "min_width": 320, "sizes": [[320, 480]], "refresh": 0}, {"device": "mobile", "adtype": "itt", "min_width": 480, "sizes": [[480, 320]], "refresh": 0}, {"device": "all_devices", "adtype": "onebyone", "min_width": 0, "sizes": [[1, 1]], "refresh": 0}, {"device": "desktop", "adtype": "headersponsor", "min_width": 0, "sizes": [[250, 100], [1066, 100]], "refresh": 0}, {"device": "mobile", "adtype": "headersponsor", "min_width": 0, "sizes": [[320, 100]], "refresh": 0}];

...
if(isDesktop) {
  ...
  if(isHome) {
    ...
    // agrego cajas
    ad_slots.push({ div: document.querySelectorAll(".col-4")[2] , location: "replace_if_filled" , id: "box_1" , adtype: "box", style: "margin-top:75px" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[3] , location: "replace_if_filled" , id: "box_2" , adtype: "box", style: "margin-top:75px" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[8] , location: "replace_if_filled" , id: "box_3" , adtype: "box", style: "margin-top:75px" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[9] , location: "replace_if_filled" , id: "box_4" , adtype: "box", style: "margin-top:75px" });
    ad_slots.push({ div: document.querySelector(".banner-right") , location: "first" , id: "box_5" , adtype: "box", style: "" });

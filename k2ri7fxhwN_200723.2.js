...
(function(t) {
t.code = 'k2ri7fxhwN.200723.2';
t.version = '200723.2#1216';
t.version_datetime = '2020-Jul-23 17:00:43';
...
adzone.slotRenderedCallback["www.lared.am/TopBanner_OnlyDesk"] = function(event) {
    if (!event.isEmpty) {
        if (ads.device.isDesktop) {
            //console.log("INIT HOME EVENT CALLBACK");
            //$(".main-header").css("height", "140px");

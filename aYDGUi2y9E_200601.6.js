...
t.styles.prestitial_close=`<img style="height: 24px;margin-top:-40px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_logo_1.png"> <img style="right:0;height: 28px;margin-top: -42px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_close_1.png">`;
...
adzone.styles.prestitial_close=`<img style="height: 18px;margin-top: -30px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_logo_1.png"> <img style="right:0;height: 19px;margin-top: -29px;position:absolute;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@2.1/pub_icons/009_close_1.png">
`;

}

adzone.videoInterval=window.setInterval(function(){ document.querySelector(".brid") && (document.querySelector(".brid").style.zIndex="2000000") },100);
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{"autoclose": "8", "backgroundColor": "rgb(255,255,255,0.95)"}'; timeout = 0; type_id='103'; params=JSON.parse('{"autoclose": "8", "backgroundColor": "rgb(255,255,255,0.95)"}'); }
      if(type_id) {

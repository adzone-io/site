...
(function(t) {
t.version = '200626.2';
t.version_datetime = '2020-Jun-26 09:39:06';
...
if(itt_last < itt_now - itt_timer ) {
  ...
  adzone.log("IIT oculto. Faltan " + (itt_now - itt_last + itt_timer ) + " minutos para mostrarlo de nuevo");
}

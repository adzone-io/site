...
adzone.add_slots_desktop_nota_entre_lineas = function() {
  var ad_slots=[];
  // itero por articulos
...
*/    
  ...
  if(isSeccion) {
    ...
    // cada 2 parrafos
    adzone.add_slots_desktop_nota_entre_lineas();
    window.setInterval(function() { adzone.add_slots_desktop_nota_entre_lineas(); }, 500);
  }

...
(function(t) {
t.version = '200626.4';
t.version_datetime = '2020-Jun-26 12:44:07';
...
t.size_mapping=[{"device": "desktop", "adtype": "header", "min_width": 0, "sizes": [[240, 90]], "refresh": 120, "interval": 0}, {"device": "desktop", "adtype": "horizontal", "min_width": 1000, "sizes": [[970, 90], [970, 250], [728, 90]], "refresh": 120, "interval": 0}, {"device": "desktop", "adtype": "horizontal", "min_width": 800, "sizes": [[728, 90], [300, 250], [320, 250], [320, 100]], "refresh": 120, "interval": 0}, {"device": "all_devices", "adtype": "horizontal", "min_width": 0, "sizes": [[300, 250], [300, 100]], "refresh": 120, "interval": 0}, {"device": "desktop", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [300, 300]], "refresh": 120, "interval": 0}, {"device": "mobile", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [300, 100]], "refresh": 120, "interval": 0}, {"device": "all_devices", "adtype": "caja_grande", "min_width": 0, "sizes": [[300, 600], [300, 250], [300, 630]], "refresh": 120, "interval": 0}, {"device": "desktop", "adtype": "flotante1", "min_width": 800, "sizes": [[1, 1], [800, 600], [1000, 600], [600, 500]], "refresh": 0, "interval": 5}, {"device": "desktop", "adtype": "flotante2", "min_width": 728, "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "flotante1", "min_width": 0, "sizes": [[320, 480]], "refresh": 0, "interval": 5}, {"device": "mobile", "adtype": "flotante2", "min_width": 0, "sizes": [[300, 50], [320, 50]], "refresh": 120, "interval": 0}, {"device": "desktop", "adtype": "flotante3", "min_width": 0, "sizes": [[1, 1]], "refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[728, 90], [300, 250], [320, 250]], "refresh": 120, "interval": 0}, {"device": "mobile", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[300, 250], [300, 100]], "refresh": 120, "interval": 0}, {"device": "mobile", "adtype": "flotante1", "min_width": 480, "sizes": [[480, 320]], "refresh": 0, "interval": 0}];

(function() {  })();
(function() { 
// extra slots
  var ad_slots = []; // count: 1
(true) && ad_slots.push({ div:  document.body , location: 'first' , id: 'flotante1' , adtype: 'flotante1', floating: false, css: '', class: '' });
adzone.create_slots(ad_slots); 
})();
    ...
    Object.keys(prepare).forEach(function(c, index) {
      ...
      if(size_details["interval"]>0 && window.sessionStorage) {
        ...
        if(time_now < last_time + size_details["interval"] ) {
          adzone.log("Will not print "+div_id+ " until next " + (last_time + size_details["interval"]-time_now) +" minutes");
          return;
        }
      }

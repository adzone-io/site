...
t.version_datetime = '2020-Nov-20 17:05:09';
...
if(p=="/") {
  ...
  adzone.section = document.body.dataset.section || "mercados";
  adzone.page = document.body.dataset.page || "home";  
...
t.forced_slots = [];
t.forced_slots.push({s: `footer`, f: `108`, t: `500`, p: `{}`, i:`` }); 

...
t.version_datetime = '2020-Aug-17 17:59:05';
...
// extra slots
  ...
  (adzone.device.isDesktop) &&   ad_slots.push({ div_txt: `document.querySelector("header")`, div: function() { return (document.querySelector("header") || null);} , location: 'after' , id: 'headertop' , adtype: 'headertop', floating: false, css: '', class: '' });
  ad_slots.length>0 && t.create_slots(ad_slots);

...
t.version_datetime = '2020-Aug-24 16:55:27';
...
adzone.slot_parse_callback = function(div){
  // esta función se llama cada vez que se encuentra un nuevo ad-slot. Con esto estamos corrigiendo la nomenclatura

  var divs = document.querySelectorAll(".ad-slot");
  for(var i=0; i<divs.length; i++) {
    divs[i].id = divs[i].id.split("#")[0];
  }
...
t.forced_slots = [];
t.forced_slots.push({s: `sticky`, f: `108`, t: `500`, p: `{}`, i:`` }); 

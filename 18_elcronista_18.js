...
t.version = '18';
t.version_datetime = '2020-Dec-10 19:54:44';
...
adzone.center_sticky = function() {
  ...
  if(s) {
    s.parentElement.style.bottom="-100px !important";
    s.style.marginLeft = "0 !important";
    var sr = s.getBoundingClientRect();
    var center2 = (sr.width/2) + sr.x;
    s.style.marginLeft = ((center-center2)*2)+"px !important";
    s.parentElement.style.bottom="0 !important";
  }
}

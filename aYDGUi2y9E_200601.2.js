...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{"autoclose": "0", "backgroundColor": "rgba(255, 255, 255, 0.95)"}'; timeout = 0; type_id='103'; params=JSON.parse('{"autoclose": "0", "backgroundColor": "rgba(255, 255, 255, 0.95)"}'); }
      if(type_id) {

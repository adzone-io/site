...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{"autoclose": "8", "backgroundColor": "#FFFFFF"}'; timeout = 0; type_id='103'; params=JSON.parse('{"autoclose": "8", "backgroundColor": "#FFFFFF"}'); }
      if(type_id) {

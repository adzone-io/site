...
t.version_datetime = '2020-Aug-17 18:08:56';
  ...
  for(var i = 0; i<ad_slots.length; i++) {
    ...
    if(anchor) {
      if(slot.id && slot.adtype) {
        ...
        if(slot.css.indexOf("overflow")<0) {
...
if(adzone.device.isMobile && adzone.page=='home') {
  ...
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[0], location: 'before' , id: 'middle1' , adtype: 'middle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[2], location: 'before' , id: 'rectangle1' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[4], location: 'before' , id: 'middle2' , adtype: 'middle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[6], location: 'before' , id: 'rectangle2' , adtype: 'rectangle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[8], location: 'before' , id: 'middle3' , adtype: 'middle' });
  ad_slots.push({ div: document.querySelectorAll(".zox-post-body p")[10], location: 'before' , id: 'rectangle3' , adtype: 'rectangle' });
...
// extra slots
  ...
  ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'top' , adtype: 'mobile-top', floating: false, css: '', class: '' });
  (adzone.device.isDesktop) &&   ad_slots.push({ div_txt: `document.querySelector("header")`, div: function() { return (document.querySelector("header") || null);} , location: 'after' , id: 'headertop' , adtype: 'headertop', floating: false, css: 'overflow:', class: '' });
  ad_slots.length>0 && t.create_slots(ad_slots);

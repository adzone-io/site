...
*/    
  ...
  if(isHome) { // home mobile
    ...
    ad_slots.push({ div: document.querySelectorAll('.entry-article > p')[0] , location: "after" , id: "wide_1" , adtype: "wide"});
    ad_slots.push({ div: document.querySelectorAll('.entry-article > p')[3] , location: "after" , id: "wide_2" , adtype: "wide" });
    ad_slots.push({ div: document.querySelectorAll('.entry-article > p')[6] , location: "after" , id: "wide_3" , adtype: "wide" });
    ad_slots.push({ div: document.querySelectorAll('.entry-article > p')[9] , location: "after" , id: "wide_4" , adtype: "wide" });
    ad_slots.push({ div: document.querySelectorAll('.entry-share') , location: "after" , id: "wide_5" , adtype: "wide" });

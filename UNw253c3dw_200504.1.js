...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('layers'.toLowerCase())>=0) { params='{ autoclose: 8, backgroundColor:"#fff" }'; timeout = 10; type_id='103'; params=JSON.parse('{ autoclose: 8, backgroundColor:"#fff" }'); }
      if(div_id.toLowerCase().indexOf('zocalo'.toLowerCase())>=0) { params='{"hide_on_page_footer":"footer"}'; timeout = 2000; type_id='108'; params=JSON.parse('{"hide_on_page_footer":"footer"}'); }

...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('flotante2'.toLowerCase())>=0) { params='{}'; timeout = 500; type_id='108'; params=JSON.parse('{}'); }
      if(div_id.toLowerCase().indexOf('flotante1'.toLowerCase())>=0) { params='{"autoclose":"8", "backgroundColor":"white"}'; timeout = 10; type_id='103'; params=JSON.parse('{"autoclose":"8", "backgroundColor":"white"}'); }
      if(type_id) {

/* eQ4R0xzQS3 - El intransigente - Prod */
...
(function(t) {
t.code = 'eQ4R0xzQS3.200716.1';
t.version = '200716.1#1138';
t.version_datetime = '2020-Jul-16 12:00:49';
...
var h = document.location.origin+document.location.pathname;
...
var section = "nota";
adzone.section = h.substr(0, h.length-1).split("/")[3]||"";
if(l==3) {
  section = "home";
  adzone.section = "home"
} else if(l<=6) {
  section = "seccion";
  adzone.section = h.substr(0, h.length-1).split("/")[4]||"";
}

adzone.site = site;

return "/" + site + "_" + section + "/"; })();
adzone.add_slots_nota_entre_lineas = function() {
  var ad_slots=[];
  // itero por articulos
  for(var i = 0; i< document.querySelectorAll("article.entry-article").length; i++) {
    var a = document.querySelectorAll("article.entry-article")[i];
    if(a.dataset.slots_agregados) { continue; }
    a.dataset.slots_agregados = "1";
    for(var i = 0; i<a.querySelectorAll(".content-field > p").length; i++){
     if(i%2==1) {
       ad_slots.push({ div: a.querySelectorAll(".content-field > p")[i] , location: "after" , id: "wide_1" , adtype: "nota_wide", style: "" });
     }
    }
  }
...
if(isDesktop) {
  ...
  if(isHome) {
    ...
    // agrego cajas
    ad_slots.push({ div: document.querySelectorAll(".col-4")[2] , location: "replace_if_filled" , id: "box_1" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[3] , location: "replace_if_filled" , id: "box_2" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[8] , location: "replace_if_filled" , id: "box_3" , adtype: "box", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[9] , location: "replace_if_filled" , id: "box_4" , adtype: "box", style: "" });
...
*/    
  ...
  if(isSeccion) {
    ...
    // cada 2 parrafos
    adzone.add_slots_nota_entre_lineas();
    window.setInterval(function() { adzone.add_slots_nota_entre_lineas(); }, 500);
  }




} else if (adzone.site=="elintranews" && isMobile) {  // MOBILE
  // todos tienen header top
  ad_slots.push({ div: document.querySelector("header") , location: "before" , id: "header_top" , adtype: "header_top", style: "height:0px;overflow:hidden" });
  // todos tienen top
  ad_slots.push({ div: document.querySelector("nav.navigation") , location: "after" , id: "top" , adtype: "top", style: "height:0px;overflow:hidden" });
  ...
  if(isHome) { // home mobile
    ...
    var id=0;
    for(var i = 1; (i<document.querySelectorAll("article.nota-7").length && id<5); i++){
     if(i%3==0) {
       id++;
       ad_slots.push({ div: document.querySelectorAll("article.nota-7")[i] , location: "after" , id: "wide_2_position_"+id , adtype: "wide", style: "" });
     }
    }

  } else { // nota mobile
    ad_slots.push({ div: document.querySelector(".entry-header") , location: "after" , id: "wide_1" , adtype: "wide", style: "" });
    ad_slots.push({ div: document.querySelectorAll('.entry-content p')[0] , location: "after" , id: "wide_1" , adtype: "wide"});
    ad_slots.push({ div: document.querySelectorAll('.entry-content p')[3] , location: "after" , id: "wide_2" , adtype: "wide" });
    ad_slots.push({ div: document.querySelectorAll('.entry-content p')[6] , location: "after" , id: "wide_3" , adtype: "wide" });
    ad_slots.push({ div: document.querySelectorAll('.entry-content p')[9] , location: "after" , id: "wide_4" , adtype: "wide" });
    ad_slots.push({ div: document.querySelector('.entry-share') , location: "after" , id: "wide_5" , adtype: "wide" });
...
t.forced_slots.push({s: `itt`, f: `103`, t: `0`, p: `{}`, i:`{}` }); 
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "desktop", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "itt", "min_width": 800, "sizes": [[800, 600], [1000, 540]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "leftbigbox", "min_width": 992, "sizes": [[300, 250], [300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "leftbox", "min_width": 992, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "nota_wide", "min_width": 700, "sizes": [[728, 90], "728", "250"], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "top", "min_width": 700, "sizes": [[970, 90], [728, 90]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "wide", "min_width": 700, "sizes": [[728, 90], "728", "250", [970, 90], [970, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "wide", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 700, "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 250], [300, 600]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "box", "min_width": 0, "sizes": [[300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "header_topXeliminado", "min_width": 0, "sizes": [[300, 250], [300, 100], [300, 50], [320, 250], [320, 100], [320, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "itt", "min_width": 0, "sizes": [[320, 480]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "nota_wide", "min_width": 0, "sizes": [[300, 250], [300, 100], [300, 50]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "topXeliminado", "min_width": 0, "sizes": [[320, 50], [300, 50], [320, 100], [300, 100]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "wide", "min_width": 0, "sizes": [[320, 50], [300, 100], [300, 50], [320, 100], [300, 250]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[1, 1], [320, 50], [300, 50]], "refresh": 60, "adx_refresh": 0, "interval": 0}];

(function() {  })();
(function() { 
// extra slots
  var ad_slots = []; // count: 3
try { 
(adzone.device.isDesktop && adzone.section=="nota") && ad_slots.push({ div_txt: `document.querySelector("header.container")`, div: function() { return (document.querySelector("header.container") || null);} , location: 'before' , id: 'header_top' , adtype: 'header_top', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot header_top')}
try { 
(adzone.device.isDesktop && adzone.section=="nota") && ad_slots.push({ div_txt: `document.querySelector("article.entry-article")`, div: function() { return (document.querySelector("article.entry-article") || null);} , location: 'first' , id: 'top' , adtype: 'top', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot top')}
try { 
(adzone.section=="nota") && ad_slots.push({ div_txt: `document.querySelector(".entry-share")`, div: function() { return (document.querySelector(".entry-share") || null);} , location: 'after' , id: 'wide_5' , adtype: 'wide', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot wide_5')}

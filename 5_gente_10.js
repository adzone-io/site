...
t.version_datetime = '2020-Sep-10 15:45:41';
...
if(adzone.page=="nota") {
  ...
  if(adzone.device.isDesktop) {
       document.querySelector("article aside.sidebar") && ad_slots.push({ div: document.querySelector("article aside.sidebar"), location: 'first' , id: 'box_1' , adtype: 'box-big' });
  ...
  adzone.device.isDesktop && ad_slots.push({ div: document.querySelectorAll("section.vc_custom_1566008394714 .vc_column-inner")[1], location: 'first' , id: 'box_1' , adtype: 'box-big' });

  ad_slots.push({ div: document.querySelector(".vc_custom_1566356545295"), location: 'before' , id: 'wide_1' , adtype: 'wide', style:'margin-bottom:-40px' });
  // antes y despues de nota de tapa
  ad_slots.push({ div: document.querySelector(".vc_custom_1566356545295"), location: 'after' , id: 'wide_2' , adtype: 'wide', style:'margin-top:-40px' });

  // despues de galeria
  ad_slots.push({ div: document.querySelectorAll("section")[5], location: 'after' , id: 'wide_3' , adtype: 'wide', style:'margin-top:40px; margin-bottom:-40px' });

  // antes y despues de no te lo pierdas
  ad_slots.push({ div: document.querySelectorAll("section")[7], location: 'before' , id: 'wide_4' , adtype: 'wide', style:'margin-bottom:-40px' });
  ad_slots.push({ div: document.querySelectorAll("section")[7], location: 'after' , id: 'wide_footer' , adtype: 'wide-big', style:'margin-top:-40px; margin-bottom:0px' });

} else if(adzone.page=="seccion") {
    
  // sidebar 
  adzone.device.isDesktop && ad_slots.push({ div: document.querySelector(".code-block-3"), location: 'first' , id: 'box_1' , adtype: 'box-big' });

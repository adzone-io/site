...
t.page_path = (function() { var pos = "seccion";
if(/^.+-n([0-9]+)$/.test(document.location.href)) {
  pos = "nota"
...
//if(document.location.href.indexOf("backend")>0) { adzone={}; return; }
var cancelar_lista = ["157776", "157776", "157776"];
for(var j=0; j<cancelar_lista.length; j++) {
  if(document.location.href.indexOf(cancelar_lista[j])>0) {
    console.log("***BORRAR ADS***");
    for(var i=0; i<document.querySelectorAll(".ad-slot").length; i++) {
      document.querySelectorAll(".ad-slot")[i].dataset.adtype="";
    }
    adzone={};
    return;
  }
}
console.log("print ads");

adzone.position = adzone.position || 0;

var ad_slots = [];

// imprimir ITT sólo cada 60 minutos
var last_itt=localStorage.getItem("last_itt") || 0;
if(last_itt < ( Math.round((new Date()).getTime()/1000/1000)-60 )) {
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      var ignore = false;
      if(e.lineItemId && ',,2698317573,'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      if(e.campaignId && ',,2698317573,'.indexOf(','+e.campaignId+',')>0) {
        ignore = true;
      }
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "mobile", "adtype": "top", "min_width": 0, "sizes": [[300, 50], [300, 100], [320, 50], [320, 100]], "refresh": 0}, {"device": "desktop", "adtype": "top", "min_width": 0, "sizes": [[970, 90], [728, 90]], "refresh": 0}, {"device": "desktop", "adtype": "horizontal", "min_width": 970, "sizes": [[970, 90], [970, 250], [728, 90]], "refresh": 0}, {"device": "mobile", "adtype": "horizontal", "min_width": 0, "sizes": [[320, 50], [320, 100], [300, 50], [300, 100]], "refresh": 0}, {"device": "mobile", "adtype": "", "min_width": 0, "sizes": [[320, 50]], "refresh": 0}, {"device": "all_devices", "adtype": "caja", "min_width": 0, "sizes": [[300, 250]], "refresh": 0}, {"device": "all_devices", "adtype": "caja_grande", "min_width": 0, "sizes": [[300, 600]], "refresh": 0}, {"device": "desktop", "adtype": "itt", "min_width": 0, "sizes": [[800, 600], [1000, 480]], "refresh": 0}, {"device": "mobile", "adtype": "itt", "min_width": 0, "sizes": [[320, 480]], "refresh": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 970, "sizes": [[1, 1], [970, 90], [728, 90], [950, 50]], "refresh": 60}, {"device": "mobile", "adtype": "zocalo", "min_width": 0, "sizes": [[1, 1], [320, 50], [300, 50]], "refresh": 60}, {"device": "desktop", "adtype": "zocalo", "min_width": 0, "sizes": [[320, 50], [300, 50]], "refresh": 60}, {"device": "desktop", "adtype": "lateral", "min_width": 0, "sizes": [[260, 600], [260, 650], [300, 600]], "refresh": 0}, {"device": "desktop", "adtype": "inline", "min_width": 0, "sizes": [[728, 90]], "refresh": 0}, {"device": "mobile", "adtype": "inline", "min_width": 0, "sizes": [[300, 600], [300, 250], [320, 250], [300, 100], [320, 100], [320, 50], [300, 50]], "refresh": 0}, {"device": "desktop", "adtype": "zocalo", "min_width": 728, "sizes": [[728, 90], [1, 1]], "refresh": 60}, {"device": "all_devices", "adtype": "caja_mixta", "min_width": 0, "sizes": [[300, 600], [300, 250]], "refresh": 0}];

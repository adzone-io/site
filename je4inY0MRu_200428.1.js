...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('Floating'.toLowerCase())>=0) { params='{}'; timeout = 10; type_id='103'; params=JSON.parse('{}'); }
      if(type_id) {
...
t.kv = (function() {  })();
t.size_mapping=[{"device": "all_devices", "adtype": "floating", "min_width": 0, "sizes": [[320, 480]]}, {"device": "all_devices", "adtype": "superbanner", "min_width": 0, "sizes": [[728, 90]]}, {"device": "all_devices", "adtype": "billboard", "min_width": 0, "sizes": [[970, 250]]}, {"device": "all_devices", "adtype": "box", "min_width": 0, "sizes": [[300, 250]]}, {"device": "all_devices", "adtype": "bigbox", "min_width": 0, "sizes": [[300, 600]]}];

...
t.version_datetime = '2020-Aug-20 17:07:56';
...
window.addEventListener('load', (event) => {
	if(pageinfo && pageinfo.type && pageinfo.type == 'interior')
	{
		...
		let paragraphValidate = index =>
		{
  			...
  			return document.querySelector(selector) && document.querySelector(selector).nextElementSibling && 'P' === document.querySelector(selector).nextElementSibling.tagName && 'P' === document.querySelector(selector).tagName && '' !== document.querySelector(selector).innerText
		}

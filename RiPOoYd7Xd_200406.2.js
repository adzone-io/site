...
function adzone_move_itt(div_id, ad_type) {
  if(document.getElementById(div_id)) {
    ...
    d.className = "ad-slot";
    d.id=div_id;
    d.dataset.adtype=ad_type;
    d.style.display="none";
    document.body.prepend(d);
  }
}
adzone_delete_div("www.americatv.com.ar/Home/Home_FullContent", "itt");
adzone_delete_div("www.americatv.com.ar/Notas/Nota_FullContent", "itt");
adzone_move_itt("www.americatv.com.ar/Home/Home_Layers_ITT", "itt");
adzone_move_itt("wwww.americatv.com.ar/Notas/Notas_Layers_ITT", "itt");
adzone_move_itt("www.americatv.com.ar/Home/Home_Zocalos_Display", "zocalo");
adzone_move_itt("www.americatv.com.ar/Notas/Notas_Zocalos_Display", "zocalo");
adzone.log("version 12");
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{"backgroundColor": "white", "autoclose":6}'; timeout = 10; type_id='120'; params=JSON.parse('{"backgroundColor": "white", "autoclose":6}'); }

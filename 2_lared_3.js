...
t.version_datetime = '2020-Aug-16 23:59:49';
...
t.get_page_path = function() { return "/www.lared.am/"; };
...
//adzone.styles.footer_bottom_margin = (window.innerWidth<=500?65:50) + "px";

    adzone.slotRenderedCallback["Notas/HomeEvent_260x650"] = function(event) {
    ...
    adzone.slotRenderedCallback["Home/HomeEvent_260x650"] = function(event) {
        if (!event.isEmpty) {      

            //Hay Residual - Ocultar el adunit "Home/Home_300x600_right

            var Home_300x600_right = document.getElementById('Home/Home_300x600_right');
            if (Home_300x600_right !== null)
    ...
    adzone.slotRenderedCallback["Home/TopBanner_950x50"] = function(event) {
        if (event.isEmpty) {
        } else {
            if (adzone.device.isDesktop) {
                $("#TopBanner_OnlyDesk").css("text-align", "center");
                //console.log("INIT HOME EVENT CALLBACK");
    ...
    adzone.slotRenderedCallback["TopBanner_OnlyDesk"] = function(event) {
        if (!event.isEmpty) {
            if (adzone.device.isDesktop) {
                //console.log("INIT HOME EVENT CALLBACK");
                $("#TopBanner_OnlyDesk").css("text-align", "center");
                $("#main-player").css("margin-top", "115px");
                $(".main-header").css("height", "140px");
                $(".main-header").css("margin-top", "115px");
                $(".main-header").attr(
                    "style",
                    "height: 140px; padding: 0!important!;margin-top:115px!important;"
                );
                $(".player-wrapper").attr("style", "margin-top: 100px");
                $(".logo").attr("style", "top: 105px!important;");
            } 
    ...
    adzone.slotRenderedCallback["Notas/TopBanner_950x50"] = function(event) {
        if (event.isEmpty) {
        } else {
            if (adzone.device.isDesktop) {
                //$(".main-header").css("height", "140px");
    ...
    adzone.slotRenderedCallback["Home/OOP_Zocalo_dsk"] = function(event) {
        if (!event.isEmpty) {            
            $("#Home\\/OOP_Zocalo_dsk").css({"bottom":"49px"});
        } 
    }

t.forced_slots = [];
t.forced_slots.push({s: `zocalo`, f: `108`, t: `10`, p: `{"hide_on_page_footer":"footer"}`, i:`{}` });
t.forced_slots.push({s: `FullContent`, f: ``, t: `10`, p: `{"backgroundColor": "white", "autoclose":8}`, i:`{}` }); 
...
t.size_mapping=[{"device": "desktop", "sizes": [[300, 600], [300, 250]], "adtype": "bigbox", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "box", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 600]], "adtype": "box600", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [950, 50], [950, 200], [950, 250], [970, 90], [970, 250]], "adtype": "firstpush", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[260, 650], [260, 600]], "adtype": "floating", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": ["fluid", [300, 250]], "adtype": "fluid", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [1000, 480], [1000, 540]], "adtype": "fullcontent", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1000, 480], [1000, 540]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [950, 50], [950, 200], [950, 250], [970, 90], [970, 250]], "adtype": "push", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[950, 50], [970, 90]], "adtype": "topbanner", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [950, 90], [950, 50], [1, 1]], "adtype": "zocalo", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1000, 541], [1000, 481]], "adtype": "flotante", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [300, 100], [300, 50], [300, 600]], "adtype": "bigbox", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250]], "adtype": "box", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250]], "adtype": "box600", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 100], [320, 50]], "adtype": "firstpush", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": ["fluid", [300, 250]], "adtype": "fluid", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1, 1], [320, 480]], "adtype": "fullcontent", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1, 1], [480, 320]], "adtype": "fullcontent", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[1000, 480], [1000, 540]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 480]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[480, 320]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250], [300, 100], [320, 50], [320, 100]], "adtype": "push", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [320, 50]], "adtype": "topbanner", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 100], [320, 50]], "adtype": "underHeader", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 50], [320, 50], [1, 1]], "adtype": "zocalo", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 481]], "adtype": "flotante", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}];

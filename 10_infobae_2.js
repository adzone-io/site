...
t.version_datetime = '2020-Aug-17 00:09:35';
...
t.get_page_path = function() { return "/" + getDfpPathRoot() + getMetaContent("dfpPageType") + "/" };
t.page_path = t.get_page_path();
function adzone_test_run() {
  document.querySelector("div.hide_lightbox")&&document.querySelector("div.hide_lightbox").parentElement&&(document.querySelector("div.hide_lightbox").parentElement.innerHTML="");
  document.querySelector("div.stick_bottom")&&document.querySelector("div.stick_bottom").parentElement&&(document.querySelector("div.stick_bottom").parentElement.innerHTML="");
 
  var d = document.createElement("div");
  d.id="interstitial_800x600";
  d.className="ad-slot";
  d.dataset.adtype="interstitial";
  d.style.display="none";
  document.body.appendChild(d);
  var d = document.createElement("div");
  d.id="zocalo_1x1";
  d.className="ad-slot";
  d.dataset.adtype="zocalo";
  d.style.display="none";
  document.body.appendChild(d);


  var ads = document.querySelectorAll(".dfpAd");
  for(var i=0; i<ads.length; i++) {
    var d = ads[i];
    var id = d.firstChild.id;
    d.classList.add("ad-slot");
    d.id = adzone_clean_id(id);
    if(d.id.indexOf("interstitial")>=0) {
      d.id = "interstitial_800x600";
    }
    d.dataset.adtype=adzone_get_adtype(id);
    d.classList.remove("dfpAd");
    d.classList.remove("stick_bottom");
    d.innerHTML="";
...
function adzone_clean_id(long_id) {
  var s = long_id.split("/");
  return s[s.length-1];
}
...
adzone_test_run();
t.forced_slots = [];
t.forced_slots.push({s: `zocalo`, f: `108`, t: `10`, p: `{}`, i:`{}` });
t.forced_slots.push({s: `interstitial`, f: `103`, t: `10`, p: `{"backgroundColor":"rgb(255,255,255,0.95)", "autoclose":"8"}`, i:`{}` }); 
...
t.kv = (function() { var d = document.querySelectorAll(".article-tag a");
var kv = {tags:[]};
for(i=0; i<d.length;i++) {
  kv.tags.push(d[i].innerHTML);
}

kv.CxSegments = getUserSegmentIdsLocal();

return kv; })();
t.size_mapping=[{"device": "desktop", "sizes": [[300, 250], "fluid"], "adtype": "box", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 600], [300, 250]], "adtype": "bigbox", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[970, 90], [970, 250], [728, 90]], "adtype": "push", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[970, 60], [970, 80]], "adtype": "top", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[250, 600], [120, 600], [160, 600]], "adtype": "megalateral", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[180, 70]], "adtype": "header", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[940, 80], [728, 90], [1, 1]], "adtype": "zocalo", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], [640, 480], [640, 360], [468, 60], "fluid"], "adtype": "inline", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[800, 600]], "adtype": "interstitial", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250], [320, 50], "fluid"], "adtype": "box", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250], [320, 50], "fluid"], "adtype": "bigbox", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 50]], "adtype": "top", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[320, 50], [1, 1]], "adtype": "zocalo", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[1, 1], "fluid"], "adtype": "inline", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 416], [320, 480]], "adtype": "interstitial", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[518, 690]], "adtype": "interstitial", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [""], "adtype": "", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}];

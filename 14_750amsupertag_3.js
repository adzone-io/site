...
t.version_datetime = '2020-Aug-20 14:03:45';
...
t.get_page_path = function() { return "/am750/"; };
t.page_path = t.get_page_path();
adzone.on_reload_check = function() {
  ...
  for(var i=0; i<slots.length; i++) {
    var s = slots[i];
    if(s.id.substring(0,3)=="ad_") {
      if(s.id.indexOf("mobile")>=0) {
        s.id = s.id.substring(3);
      } else {
        s.id = ubicacion + s.id.substring(2);  
      }
    }
  }   
  adzone.refresh();
};
adzone.on_reload_check();
//document.querySelectorAll(".adzone-reload").length;
t.forced_slots = [];
...
t.kv = (function() { var tags_html = document.querySelectorAll(".tags-links a");
var tags = [];
for(var i=0; i<tags_html.length;i++) {
  tags.push(tags_html[i].innerHTML);
}
return { "tags": tags }; })();
t.size_mapping=[{"device": "desktop", "sizes": [[300, 600]], "adtype": "bigbox", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[728, 90], [970, 90]], "adtype": "billboard", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 250]], "adtype": "box", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[800, 600]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[300, 800], [300, 600], [160, 600], [336, 280]], "adtype": "sidebar", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "sizes": [[970, 90], [728, 90]], "adtype": "zocalo", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 600]], "adtype": "bigbox", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 50]], "adtype": "billboard_mobile", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[300, 250]], "adtype": "box_mobile", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 480]], "adtype": "itt", "min_width": 0, "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "sizes": [[320, 50], [300, 50]], "adtype": "zocalo", "min_width": 0, "refresh": 60, "adx_refresh": 0, "interval": 0}];

...
if(d.indexOf("paparazzi")>0) {
  ...
  seccion="parati";
  if(l==3){seccion+="_home"; } else if(d.indexOf("categoria")>0) { seccion+="_seccion"; } else { seccion+="_nota"; }
} else { //gente
  seccion = "gente"

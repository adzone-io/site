/* UCJ8Dhn9ZY - Copy of los 4 Sitios chicos */
...
googletag.cmd.push(function() { 
  googletag.pubads().addEventListener("slotRenderEnded", function(e) {
    ...
    if(!e.isEmpty && e.size && e.size[0] && e.size[0]>10) {
      ...
      if(!ignore && div_id.toLowerCase().indexOf('itt'.toLowerCase())>=0) { params='{}'; timeout = 10; type_id='103'; params=JSON.parse('{}'); }
      var ignore = false;
      if(e.lineItemId && ',,{},'.indexOf(','+e.lineItemId+',')>0) {
        ignore = true;
      }
      ...
      if(!ignore && div_id.toLowerCase().indexOf('zocalo'.toLowerCase())>=0) { params='{}'; timeout = 10; type_id='108'; params=JSON.parse('{}'); }
      if(type_id) {

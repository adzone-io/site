...
t.version = '..15';
t.supertag = true;
localStorage && localStorage.getItem && localStorage.removeItem("adzone-debug")
if(true || t.version.substring(1,10)!="-DRAFT-") {
...
t.version_datetime = '2020-Aug-19 14:26:39';
...
t.get_page_path = function() { return "/111112"  };

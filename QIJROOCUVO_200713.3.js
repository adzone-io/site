/* QIJROOCUVO - iproup / iprofesional */
...
(function(t) {
t.code = 'QIJROOCUVO.200713.3';
t.version = '200713.3#1109';
t.version_datetime = '2020-Jul-13 17:12:03';
...
t.page_path = (function() { if(pageinfo.section == "home") {
  adzone.section = "home";
...
if(pageinfo.type == "interior")
{
    if (document.querySelectorAll('.textonota p').length < ((adsCount + 1) * parMin))
    {
        adsCount = Math.ceil((document.querySelectorAll('.textonota p').length / parMin) - 1)
    }
    let parCount = Math.ceil(document.querySelectorAll('.textonota p').length / (adsCount + 1))
    document.querySelectorAll('.textonota p').forEach(function (item, index) {
        if (0 === (index % parCount) && index > 0 && index !== (document.querySelectorAll('.textonota p').length - 1))
        {
            ad_slots.push({ div: document.querySelectorAll('.textonota > p')[index] , location: "after" , id: "horizontal4" , adtype: "horizontal_nota" })
        }
    })
...
*/
  if(e.slot.getSlotElementId()=="lateral" && !(e.slot.isEmpty)) {
...
return kv; })();
t.size_mapping=[{"device": "desktop", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [300, 300]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "caja_grande", "min_width": 0, "sizes": [[300, 600], [300, 250], [300, 630]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "flotante1", "min_width": 800, "sizes": [[1, 1], [800, 600], [1000, 600], [600, 500]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "flotante2", "min_width": 728, "sizes": [[1, 1], [728, 90], [970, 90], [970, 251]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "flotante3", "min_width": 0, "sizes": [[1, 1]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "desktop", "adtype": "header", "min_width": 0, "sizes": [[240, 90]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "horizontal", "min_width": 1000, "sizes": [[970, 90], [970, 250], [728, 90], [970, 200], [950, 90], [950, 300], [950, 350]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "horizontal", "min_width": 800, "sizes": [[728, 90], [300, 250], [320, 250], [320, 100]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[728, 90], [300, 250], [320, 250]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "inread", "min_width": 0, "sizes": [[680, 400]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "desktop", "adtype": "lateral", "min_width": 1300, "sizes": [[250, 600]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "caja", "min_width": 0, "sizes": [[300, 250], [300, 100]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "caja_grande", "min_width": 0, "sizes": [[300, 600], [300, 250], [300, 630]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "flotante1", "min_width": 0, "sizes": [[1, 1], [320, 480]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "flotante1", "min_width": 480, "sizes": [[1, 1], [480, 320]], "refresh": 0, "adx_refresh": 0, "interval": 0}, {"device": "mobile", "adtype": "flotante2", "min_width": 0, "sizes": [[300, 50], [320, 50], [300, 100], [320, 100]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "horizontal", "min_width": 0, "sizes": [[300, 250], [300, 100], [320, 100], [320, 250]], "refresh": 60, "adx_refresh": 1, "interval": 0}, {"device": "mobile", "adtype": "horizontal_nota", "min_width": 0, "sizes": [[300, 250], [300, 100]], "refresh": 60, "adx_refresh": 1, "interval": 0}];
...
try { 
(true) && ad_slots.push({ div_txt: `document.body`, div: function() { return (document.body || null);} , location: 'first' , id: 'flotante1' , adtype: 'flotante1', floating: false, css: '', class: '' }); } catch(e) { adzone.log('** Error creating slot flotante1')}

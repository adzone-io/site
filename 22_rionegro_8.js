...
t.code = '22_rionegro';
t.version = '8';
t.version_datetime = '2020-Nov-17 15:16:41';
...
t.styles.prestitial_close=`<img style="float:left;max-width:48px;max-height:48px;width:48px;height:48px;margin-top:-34px;float: left;margin-right:-28px;" src="https://cdn.jsdelivr.net/gh/adzone-io/rm@1.0.0/icon/close2.png">`;
...
t.styles.footer_z_index=`2147483630`;
t.styles.itt_z_index=`2147483640`;



t.forced_slots = [];
t.forced_slots.push({s: `itt`, f: `103`, t: `10`, p: `{}`, i:`` });
t.forced_slots.push({s: `zocalo`, f: `108`, t: `2000`, p: `{}`, i:`` }); 

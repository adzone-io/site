...
if(isDesktop) {
  ...
  if(isHome) {
    ...
    // agrego cajas
    ad_slots.push({ div: document.querySelectorAll(".col-4")[2] , location: "replace_if_filled" , id: "box_1" , adtype: "bigbox", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[3] , location: "replace_if_filled" , id: "box_2" , adtype: "bigbox", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[8] , location: "replace_if_filled" , id: "box_3" , adtype: "bigbox", style: "" });
    ad_slots.push({ div: document.querySelectorAll(".col-4")[9] , location: "replace_if_filled" , id: "box_4" , adtype: "bigbox", style: "" });
...
*/    
  ...
  if(isSeccion) {
    ...
    // arriba del copete
    ad_slots.push({ div: document.querySelectorAll("article")[i] , location: "before" , id: "wide_1" , adtype: "nota_wide", style: "" });
    // cada 2 parrafos

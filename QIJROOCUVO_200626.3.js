...
(function(t) {
t.version = '200626.3';
t.version_datetime = '2020-Jun-26 09:40:56';
...
var itt_timer = 5;
var itt_last =localStorage.getItem("itt_last") || 0;
var itt_now = Math.round((new Date()).getTime()/1000/1000);

if(itt_last < itt_now - itt_timer ) {
  localStorage.setItem("itt_last", itt_now);
  ad_slots.push({ div: document.body , location: "last" , id: "flotante1" , adtype: "flotante1", style: "display:none" });
} else {
  adzone.log("Flotante1 (IIT) oculto. Faltan " + (itt_now - itt_last + itt_timer ) + " minutos para mostrarlo de nuevo");
}

...
t.version_datetime = '2020-Sep-10 05:56:13';
...
if(adzone.page=="nota") {
  ...
  adzone.device.isDesktop && (
       document.querySelector("article aside.sidebar") && ad_slots.push({ div: document.querySelector("article aside.sidebar"), location: 'first' , id: 'box_1' , adtype: 'bigbox' }) 
